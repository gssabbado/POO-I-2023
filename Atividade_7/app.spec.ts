...
describe('App', () => {
    it('should correctly calculate the rent amount', async () => {
        ...
        const bike = new Bike('BMX 157', 'Road',  18, 150, 500, true,'Mais rápido que relâmpago marquinhos.', 
        4.5, ['image2.jpg'], '2', )
    ...
    it('should throw an exception when trying to move an unregistered bike', () => {
        ...
        const moveUnregisteredBike = () => {
            app.moveBikeTo(bike.id, new Location(13.5357999, 144.8026399))
        };

        expect(moveUnregisteredBike).toThrow('Bike not registered')
    });
})